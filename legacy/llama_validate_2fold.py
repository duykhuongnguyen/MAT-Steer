# Custom llama method of validating 2fold (with head_out)
import torch
...
import sys
sys.path.append('../')
from llama_utils import alt_tqa_evaluate, flattened_idx_to_layer_head, layer_head_to_flattened_idx, get_interventions_dict, get_top_heads, get_separated_activations, get_com_directions
import llama
